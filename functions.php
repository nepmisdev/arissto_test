...
function metaAccountTest(){
	...
	$test_user_id = 4;
	$user_nickname = get_user_meta( $test_user_id, 'nickname', 1 );
	$user_first_name = get_user_meta( $test_user_id, 'first_name', 1 );
	$user_last_name = get_user_meta( $test_user_id, 'last_name', 1 );
	$user_billing_first_name = get_user_meta( $test_user_id, 'billing_first_name', 1 );
	$user_billing_last_name = get_user_meta( $test_user_id, 'billing_last_name', 1 );
	$user_billing_company = get_user_meta( $test_user_id, 'billing_company', 1 );
	$user_billing_email = get_user_meta( $test_user_id, 'billing_email', 1 );
	$user_billing_phone = get_user_meta( $test_user_id, 'billing_phone', 1 );
	$user_billing_country = get_user_meta( $test_user_id, 'billing_country', 1 );
	$user_billing_address_1 = get_user_meta( $test_user_id, 'billing_address_1', 1 );
	$user_billing_address_2 = get_user_meta( $test_user_id, 'billing_address_2', 1 );
	$user_billing_city = get_user_meta( $test_user_id, 'billing_city', 1 );
	$user_billing_state = get_user_meta( $test_user_id, 'billing_state', 1 );
	$user_billing_postcode = get_user_meta( $test_user_id, 'billing_postcode', 1 );
...
<html lang="en">
	...
	<body>
		<?php echo $user_nickname; ?><br/>
		<?php echo $user_first_name; ?><br/>
		<?php echo $user_last_name; ?><br/>
		<?php echo $user_billing_first_name; ?><br/>
		<?php echo $user_billing_last_name; ?><br/>
		<?php echo $user_billing_company; ?><br/>
		<?php echo $user_billing_email; ?><br/>
		<?php echo $user_billing_phone; ?><br/>
		<?php echo $user_billing_country; ?><br/>
		<?php echo $user_billing_address_1; ?><br/>
		<?php echo $user_billing_address_2; ?><br/>
		<?php echo $user_billing_city; ?><br/>
		<?php echo $user_billing_state; ?><br/>
		<?php echo $user_billing_postcode; ?><br/>
	</body>
</html>
<?php
}
